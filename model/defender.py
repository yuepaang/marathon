...
class Defender(Model):
    ...
    def step(self):
        ...
        ############# py ##############
        # for pos in next_pos:
        #     curr_reward = self.explore(
        #         pos, self.map_score.tolist(), pos, 0, exploration, visited, 1, 6
        #     )
        #     if curr_reward >= exploration["reward"]:
        #         curr_reward = exploration["reward"]
        #         exploration["trace"] = pos
        # rewards = [
        #     self.explore(
        #         pos, self.map_score.tolist(), pos, 0, exploration, visited, 1, 6
        #     )
